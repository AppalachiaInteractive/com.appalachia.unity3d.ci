...
namespace Appalachia.CI.Constants
{
    public static partial class APPASTR
    {
        ...
        public const string Hide_Flags = Hide + " " + Flags;
        ...
        public const string Convert_To_Package = Convert + " " + To + " " + Package;
        public const string Convert_To_Repository = Convert + " " + To + " " + Repository;
        ...
        public const string Reanalyze_All = Reanalyze + " " + All;
        ...
        public const string Reserialize_All = Reserialize + " " + All;
        public const string Reset = "Reset";
        public const string Reset_Context = Reset + " " + Context;
