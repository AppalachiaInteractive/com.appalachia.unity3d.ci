...
#region Profiling And Tracing Markers
        ...
        private static readonly ProfilerMarker _PRF_CreateDirectoryStructureForFilePath = new ProfilerMarker(_PRF_PFX + nameof(CreateDirectoryStructureForFilePath));
#endregion
        ...
        /// </exception>
        public static AppaDirectoryInfo CreateDirectoryStructureForFilePath(string path)
        {
            using (_PRF_CreateDirectoryStructureForFilePath.Auto())
            {
