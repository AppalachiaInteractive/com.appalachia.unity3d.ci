    ...
    public static class FileLock
    {
        public static RM_PROCESS_INFO[] FindLockerProcesses(string path)
        {
            ...
            try
            {
                ...
                if (RmRegisterResources(handle, (uint) resources.LongLength, resources, 0, null, 0, null) !=
        ...
        ///     A pointer to an array size necessary to receive RM_PROCESS_INFO structures required to return information for all affected applications and
        ///     services.
        /// </param>
        ...
        private static extern RmResult RmStartSession(
        ...
        public enum RmResult
        {
            ...
            ///     This error value is returned by Restart Manager function if a NULL pointer or 0 is passed in a parameter that requires a non-null and non-zero
            ///     value.
            /// </summary>
        ...
        public struct RM_PROCESS_INFO
        {
            ...
            /// <summary>
            ///     Contains an RM_APP_TYPE enumeration value that specifies the type of application as RmUnknownApp, RmMainWindow, RmOtherWindow, RmService,
